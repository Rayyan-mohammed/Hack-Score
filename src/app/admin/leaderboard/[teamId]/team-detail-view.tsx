...
import type { TeamEvaluationBreakdown } from "@/lib/evaluations";
...
/** Presentational team-evaluation breakdown. Data is fetched by the page. */
export function TeamDetailView({
  data,
}: {
  data: NonNullable<TeamEvaluationBreakdown>;
}) {
